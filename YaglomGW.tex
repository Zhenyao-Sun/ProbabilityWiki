...
%new
A $X$-$g(X)$-size-biased transform of of $X$ is simply called a size-biased transform of of $X$.
%end new
...
\end{split}
\end{equation}
	As a consequence, in order to show the Yaglom's theorem, 
...
Therefore, if $\dot Z_n/n$ converges weakly to, say, $\dot Y$, 
	...
	this view of exponential convergence with the methods used in \cite{geiger2000new} and \cite{lyons1995conceptual}.
