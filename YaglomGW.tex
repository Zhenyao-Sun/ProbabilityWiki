%%%----Versions-----------------------------
%---YaglomGW21.tex 2018/5/13  by Zhenyao-------
...
%	and under \eqref{eq: convergence of conditional expectation}, 
...
%	The $k(k-1)$-type size-biased tree will be only used to derive result \eqref{eq: convergence after size-biased}.
